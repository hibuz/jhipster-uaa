...
```
$ docker image tag test hibuz/test
$ docker push hibuz/test
$ docker image tag gateway hibuz/gateway
$ docker push hibuz/gateway
$ docker image tag uaa hibuz/uaa
$ docker push hibuz/uaa
```
